...
import {
    MyApplicationsIcon, UserSignInIcon, MyTestDataIcon, 
    ReportDataIcon, ManageUsersIcon, AccountHomeIcon,
    FacilityBasedPreviewIcon, PaymentIcon, 
    PhysicianCompareIcon, HardshipIcon, TargetIcon,
    ReportsIcon, HelpSupportIcon, DashboardIcon,AccountSettings, 
    DetailsIcon, CliniciansIcon, GroupReporting, IndividualReporting,
    ChevronLeft, ChevronRight, ChevronDown, 
    SwitchPractice, ScoreIncrease, TooltipIcon,NavCollapse, 
    NavExpand, CloseXIcon, CloseXIcon2, EarlyClaims,
    CliniciansList, YoutubeIcon, TwitterIcon, WiViewReportsIcon,
    BellOutline, StarIcon, WiViewProgressIcon,WiManageGroupIcon
