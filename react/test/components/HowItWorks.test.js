...
describe("HowItWorks", () => {
    ...
    it("opens the info section when the link is clicked", () => {
        ...
        expect(
            screen.getByText(/To complete this process:/)
        ).toBeInTheDocument();
    });
    ...
    it("drops the flush-left modifier when align is right", () => {
        render(<HowItWorks align="right">{body}</HowItWorks>);
    ...
    describe("controlled mode", () => {
        it("respects an external isOpen=true prop without internal state", () => {
            render(<HowItWorks isOpen={true}>{body}</HowItWorks>);
            expect(
                screen.getByTestId("how-it-works-content")
            ).toBeInTheDocument();
            expect(
                screen.queryByTestId("how-it-works-link")
            ).not.toBeInTheDocument();
        });
