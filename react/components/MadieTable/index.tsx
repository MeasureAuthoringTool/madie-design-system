...
export interface MadieTableProps<TData> {
    table: Table<TData>;
    currentSort?: string;
                ...
                {table.getHeaderGroups().map((headerGroup) => (
                    <tr key={headerGroup.id}>
                        {headerGroup.headers.map((header) => {
                            const isHovered = hoveredHeader?.includes(
                                header.id
                            );
                                ...
                                >
                                    {header.isPlaceholder ? null : header.column.getCanSort() ? (
                                        <button
                                            ...
                                            data-testid={`header-${header.id.replace(
                                                "_",
                                                "."
                                            )}`}
                                            title={
