            ...
            operation.attempt(() => {
                fetchTtl(cookies.qpp_auth_token)
                    ...
                    .catch((error) => {
                        ...
                        this.forceTimeoutHandle = setTimeout(
                            this.signOut,
                            120 * 1000
                        );
                        this.setState({
    ...
    render() {
        return (
            <React.Fragment>
                ...
                >
                    <p>
                        You have been inactive for thirty minutes. For your
                        security, we will sign you out automatically.
                    </p>
                </Modal>
                ...
                >
                    <p>
                        We’re experiencing technical difficulties. Please log in
                        again to continue. For your security, we will sign you
                        out automatically within two minutes.
                    </p>
                </Modal>
            </React.Fragment>
        );
